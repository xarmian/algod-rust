...
##   - go-algorand@v4.7.4-stable `algokey` binary on PATH (compat matrix only;
...
## Boots a real go-algorand v4.7.4-stable node (in Docker) and a real
...
## real go-algorand v4.7.4-stable nodes in plain P2P mode, chain-bootstrapped
...
help:
	...
	@echo '                        go-algorand@v4.7.4-stable `algokey` on PATH for the'
