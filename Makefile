...
##   - go-algorand@v5.0.2-stable `algokey` binary on PATH (compat matrix only;
...
## Boots a real go-algorand v5.0.2-stable node (in Docker) and a real
...
## v5.0.2-stable's ConsensusCurrentVersion V42 (LogicSigVersion 13), so
...
help:
	...
	@echo '                        go-algorand@v5.0.2-stable `algokey` on PATH for the'
