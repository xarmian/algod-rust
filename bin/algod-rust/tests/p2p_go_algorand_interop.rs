...
//!
//! Dials a real go-algorand v4.7.3-stable node running in plain P2P mode
...
#[tokio::test]
#[ignore = "requires a live go-algorand v4.7.3-stable node in P2P mode — see ops/mixed-cluster-p2p/scripts/start.sh"]
...
#[tokio::test]
#[ignore = "requires the live 3-node go-algorand v4.7.3-stable chain — see ops/mixed-cluster-p2p/scripts/start.sh"]
