...
//!
//! Dials a real go-algorand v5.0.2-stable node running in plain P2P mode
...
#[tokio::test]
#[ignore = "requires a live go-algorand v5.0.2-stable node in P2P mode — see ops/mixed-cluster-p2p/scripts/start.sh"]
...
#[tokio::test]
#[ignore = "requires the live 3-node go-algorand v5.0.2-stable chain — see ops/mixed-cluster-p2p/scripts/start.sh"]
