...
| `out-of-scope` | 381 | 12% |
| `not-implemented` | 367 | 12% |
| `missing-test` | 298 | 9% |
| `matched-many:1` | 205 | 6% |

**665 rows (`not-implemented` + `missing-test`, 21%) are real, actionable
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 83 | 147 | 6 | 123 | 18 | 48 | 24 |
...
| **Total** | | **3,177** | **654** | **523** | **205** | **749** | **367** | **298** | **381** |
