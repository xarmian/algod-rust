...
| `matched-1:1` | 842 | 26% |
| `partial` | 739 | 23% |
| `matched-1:many` | 618 | 19% |
| `out-of-scope` | 469 | 15% |
| `matched-many:1` | 209 | 7% |
| `missing-test` | 181 | 6% |
| `not-implemented` | 121 | 4% |

**302 rows (`not-implemented` + `missing-test`, 9%) are real, actionable
...
| Data structures (`data/basics`, `data/bookkeeping`, ...) | [parity_data_misc.md](phase17/parity_data_misc.md) | 274 | 105 | 21 | 47 | 62 | 18 | 14 | 7 |
...
| **Total** | | **3,179** | **842** | **618** | **209** | **739** | **121** | **181** | **469** |
