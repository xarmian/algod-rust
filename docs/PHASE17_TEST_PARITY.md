...
implements but never tests. `partial` (592, 19%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 49 | 120 | 44 | 118 | 0 | 0 | 172 |
...
| **Total** | | **3,181** | **1012** | **764** | **221** | **592** | **0** | **0** | **592** |
