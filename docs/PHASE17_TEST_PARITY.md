...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,020 | 32% |
| `matched-1:many` | 775 | 24% |
| `out-of-scope` | 604 | 19% |
| `partial` | 555 | 17% |
| `matched-many:1` | 227 | 7% |
| `not-implemented` | 0 | 0% |
| `missing-test` | 0 | 0% |
...
implements but never tests. `partial` (555, 17%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 57 | 131 | 50 | 81 | 0 | 0 | 184 |
...
| **Total** | | **3,181** | **1020** | **775** | **227** | **555** | **0** | **0** | **604** |
