...
| `partial` | 710 | 22% |
| `matched-1:1` | 559 | 18% |
| `not-implemented` | 521 | 16% |
| `matched-1:many` | 500 | 16% |
| `out-of-scope` | 379 | 12% |
| `missing-test` | 303 | 10% |
| `matched-many:1` | 205 | 6% |

**824 rows (`not-implemented` + `missing-test`, 26%) are real, actionable
gaps** — either a behavior algod-rust doesn't implement yet, or one it
implements but never tests. `partial` (710, 22%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 71 | 146 | 6 | 120 | 29 | 53 | 24 |
...
| **Total** | | **3,177** | **559** | **500** | **205** | **710** | **521** | **303** | **379** |
