...
**865 rows (`not-implemented` + `missing-test`, 27%) are real, actionable
gaps** — either a behavior algod-rust doesn't implement yet, or one it
implements but never tests. `partial` (717, 23%) is coverage that exists
...
| **Total** | | **3,177** | **532** | **484** | **205** | **717** | **520** | **345** | **374** |
