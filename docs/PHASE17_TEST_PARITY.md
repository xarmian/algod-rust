...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,033 | 32% |
| `matched-1:many` | 790 | 25% |
| `out-of-scope` | 613 | 19% |
| `partial` | 516 | 16% |
...
implements but never tests. `partial` (516, 16%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 70 | 146 | 52 | 42 | 0 | 0 | 193 |
...
| **Total** | | **3,181** | **1033** | **790** | **229** | **516** | **0** | **0** | **613** |
