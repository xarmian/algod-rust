...
**735 rows (`not-implemented` + `missing-test`, 23%) are real, actionable
gaps** — either a behavior algod-rust doesn't implement yet, or one it
implements but never tests. `partial` (725, 23%) is coverage that exists
...
| **Total** | | **3,177** | **617** | **515** | **205** | **725** | **438** | **297** | **380** |
