...
implements but never tests. `partial` (510, 16%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 71 | 148 | 52 | 36 | 0 | 0 | 196 |
...
| **Total** | | **3,181** | **1034** | **792** | **229** | **510** | **0** | **0** | **616** |
