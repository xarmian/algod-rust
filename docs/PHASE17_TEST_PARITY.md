...
implements but never tests. `partial` (264, 8%) is coverage that exists
...
| e2e integration (`test/e2e-go`) | [parity_e2e.md](phase17/parity_e2e.md) | 195 | 69 | 35 | 3 | 40 | 0 | 0 | 48 |
...
| **Total** | | **3,181** | **1096** | **907** | **243** | **264** | **0** | **2** | **669** |
