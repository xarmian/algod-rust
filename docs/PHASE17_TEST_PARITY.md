...
implements but never tests. `partial` (426, 13%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 129 | 213 | 6 | 68 | 0 | 0 | 33 |
...
| **Total** | | **3,181** | **1052** | **826** | **239** | **426** | **0** | **0** | **638** |
