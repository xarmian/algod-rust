...
implements but never tests. `partial` (460, 14%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 120 | 191 | 6 | 102 | 0 | 0 | 30 |
...
| **Total** | | **3,181** | **1043** | **804** | **239** | **460** | **0** | **0** | **635** |
