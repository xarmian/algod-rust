...
| `matched-1:1` | 793 | 25% |
| `partial` | 733 | 23% |
| `matched-1:many` | 603 | 19% |
| `out-of-scope` | 424 | 13% |
| `not-implemented` | 217 | 7% |
| `matched-many:1` | 209 | 7% |
| `missing-test` | 200 | 6% |

**417 rows (`not-implemented` + `missing-test`, 13%) are real, actionable
...
| Daemon/node/rpcs (`daemon/algod`, `node`, `rpcs`) | [parity_daemon_node.md](phase17/parity_daemon_node.md) | 144 | 54 | 59 | 1 | 10 | 6 | 4 | 10 |
...
| **Total** | | **3,179** | **793** | **603** | **209** | **733** | **217** | **200** | **424** |
