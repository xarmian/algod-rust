...
implements but never tests. `partial` (550, 17%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 57 | 134 | 50 | 76 | 0 | 0 | 186 |
...
| **Total** | | **3,181** | **1020** | **778** | **227** | **550** | **0** | **0** | **606** |
