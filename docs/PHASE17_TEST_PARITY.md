...
implements but never tests. `partial` (459, 14%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 121 | 191 | 6 | 101 | 0 | 0 | 30 |
...
| **Total** | | **3,181** | **1044** | **804** | **239** | **459** | **0** | **0** | **635** |
