...
implements but never tests. `partial` (336, 11%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 101 | 75 | 12 | 49 | 0 | 0 | 26 |
...
| **Total** | | **3,181** | **1073** | **880** | **240** | **336** | **0** | **0** | **652** |
