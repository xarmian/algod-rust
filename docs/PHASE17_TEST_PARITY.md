...
| `missing-test` | 181 | 6% |
| `not-implemented` | 147 | 5% |

**328 rows (`not-implemented` + `missing-test`, 10%) are real, actionable
gaps** — either a behavior algod-rust doesn't implement yet, or one it
implements but never tests. `partial` (738, 23%) is coverage that exists
...
| Crypto (`crypto`, `crypto/stateproof`, ...) | [parity_crypto.md](phase17/parity_crypto.md) | 276 | 82 | 33 | 16 | 60 | 33 | 31 | 21 |
...
| **Total** | | **3,179** | **830** | **615** | **209** | **738** | **147** | **181** | **459** |
