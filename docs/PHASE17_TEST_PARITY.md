...
implements but never tests. `partial` (293, 9%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 112 | 89 | 12 | 6 | 0 | 0 | 44 |
...
| **Total** | | **3,181** | **1084** | **894** | **240** | **293** | **0** | **0** | **670** |
