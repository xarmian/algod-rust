...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,204 | 38% |
| `matched-1:many` | 944 | 30% |
| `out-of-scope` | 737 | 23% |
...
implements but never tests. `partial` (9, 0%) is coverage that exists
...
| Daemon/node/rpcs (`daemon/algod`, `node`, `rpcs`) | [parity_daemon_node.md](phase17/parity_daemon_node.md) | 144 | 62 | 69 | 1 | 1 | 0 | 0 | 11 |
| Data structures (`data/basics`, `data/bookkeeping`, ...) | [parity_data_misc.md](phase17/parity_data_misc.md) | 274 | 144 | 42 | 48 | 1 | 0 | 0 | 39 |
...
| **Total** | | **3,181** | **1204** | **944** | **285** | **9** | **0** | **2** | **737** |
