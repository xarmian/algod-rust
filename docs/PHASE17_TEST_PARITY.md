...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,034 | 33% |
| `matched-1:many` | 793 | 25% |
| `out-of-scope` | 616 | 19% |
| `partial` | 509 | 16% |
...
implements but never tests. `partial` (509, 16%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 71 | 149 | 52 | 35 | 0 | 0 | 196 |
...
| **Total** | | **3,181** | **1034** | **793** | **229** | **509** | **0** | **0** | **616** |
