...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,051 | 33% |
| `matched-1:many` | 817 | 26% |
| `out-of-scope` | 638 | 20% |
| `partial` | 436 | 14% |
...
implements but never tests. `partial` (436, 14%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 128 | 204 | 6 | 78 | 0 | 0 | 33 |
...
| **Total** | | **3,181** | **1051** | **817** | **239** | **436** | **0** | **0** | **638** |
