...
**372 rows (`not-implemented` + `missing-test`, 12%) are real, actionable
...
| Daemon/node/rpcs (`daemon/algod`, `node`, `rpcs`) | [parity_daemon_node.md](phase17/parity_daemon_node.md) | 144 | 57 | 62 | 1 | 11 | 2 | 1 | 10 |
...
| **Total** | | **3,179** | **822** | **612** | **209** | **740** | **194** | **178** | **424** |
