...
| `matched-1:1` | 952 | 30% |
| `partial` | 765 | 24% |
| `matched-1:many` | 662 | 21% |
| `out-of-scope` | 582 | 18% |
| `matched-many:1` | 210 | 7% |
| `not-implemented` | 7 | 0% |
| `missing-test` | 1 | 0% |

**8 rows (`not-implemented` + `missing-test`, 0%) are real, actionable
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 97 | 59 | 11 | 76 | 5 | 0 | 15 |
...
| **Total** | | **3,179** | **952** | **662** | **210** | **765** | **7** | **1** | **582** |
