...
implements but never tests. `partial` (320, 10%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 105 | 81 | 12 | 33 | 0 | 0 | 32 |
...
| **Total** | | **3,181** | **1077** | **886** | **240** | **320** | **0** | **0** | **658** |
