...
implements but never tests. `partial` (465, 15%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 118 | 188 | 6 | 107 | 0 | 0 | 30 |
...
| **Total** | | **3,181** | **1041** | **801** | **239** | **465** | **0** | **0** | **635** |
