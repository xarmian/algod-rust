...
implements but never tests. `partial` (528, 17%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 66 | 143 | 52 | 54 | 0 | 0 | 188 |
...
| **Total** | | **3,181** | **1029** | **787** | **229** | **528** | **0** | **0** | **608** |
