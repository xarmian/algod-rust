...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,029 | 32% |
| `matched-1:many` | 788 | 25% |
| `out-of-scope` | 608 | 19% |
| `partial` | 527 | 17% |
| `matched-many:1` | 229 | 7% |
| `not-implemented` | 0 | 0% |
| `missing-test` | 0 | 0% |
...
implements but never tests. `partial` (527, 17%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 66 | 144 | 52 | 53 | 0 | 0 | 188 |
...
| **Total** | | **3,181** | **1029** | **788** | **229** | **527** | **0** | **0** | **608** |
