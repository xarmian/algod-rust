...
**375 rows (`not-implemented` + `missing-test`, 12%) are real, actionable
...
| Agreement protocol (`agreement`) | [parity_agreement.md](phase17/parity_agreement.md) | 326 | 144 | 37 | 77 | 49 | 0 | 16 | 3 |
...
| **Total** | | **3,179** | **820** | **612** | **209** | **739** | **194** | **181** | **424** |
