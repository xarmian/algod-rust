...
implements but never tests. `partial` (297, 9%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 109 | 88 | 12 | 10 | 0 | 0 | 44 |
...
| **Total** | | **3,181** | **1081** | **893** | **240** | **297** | **0** | **0** | **670** |
