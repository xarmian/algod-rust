...
**898 rows (`not-implemented` + `missing-test`, 28%) are real, actionable
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 40 | 91 | 39 | 131 | 40 | 36 | 126 |
...
| **Total** | | **3,177** | **515** | **478** | **200** | **719** | **520** | **378** | **367** |
