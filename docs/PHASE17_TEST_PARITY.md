...
| `out-of-scope` | 381 | 12% |
| `not-implemented` | 345 | 11% |
| `missing-test` | 295 | 9% |
| `matched-many:1` | 205 | 6% |

**640 rows (`not-implemented` + `missing-test`, 20%) are real, actionable
...
| Config/stateproof/protocol | [parity_config_proto_sp.md](phase17/parity_config_proto_sp.md) | 119 | 16 | 19 | 0 | 30 | 44 | 6 | 4 |
...
| **Total** | | **3,177** | **667** | **536** | **205** | **748** | **345** | **295** | **381** |
