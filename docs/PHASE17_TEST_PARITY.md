...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,071 | 34% |
| `matched-1:many` | 876 | 28% |
| `out-of-scope` | 648 | 20% |
| `partial` | 347 | 11% |
...
implements but never tests. `partial` (347, 11%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 99 | 71 | 11 | 60 | 0 | 0 | 22 |
...
| **Total** | | **3,181** | **1071** | **876** | **239** | **347** | **0** | **0** | **648** |
