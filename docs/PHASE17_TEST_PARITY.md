...
| `partial` | 749 | 24% |
| `matched-1:1` | 666 | 21% |
| `matched-1:many` | 530 | 17% |
| `out-of-scope` | 381 | 12% |
| `not-implemented` | 348 | 11% |
| `missing-test` | 298 | 9% |
| `matched-many:1` | 205 | 6% |

**646 rows (`not-implemented` + `missing-test`, 20%) are real, actionable
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 83 | 148 | 6 | 122 | 18 | 48 | 24 |
...
| **Total** | | **3,177** | **666** | **530** | **205** | **749** | **348** | **298** | **381** |
