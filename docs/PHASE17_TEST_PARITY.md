...
implements but never tests. `partial` (472, 15%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 118 | 185 | 6 | 114 | 0 | 0 | 26 |
...
| **Total** | | **3,181** | **1041** | **798** | **239** | **472** | **0** | **0** | **631** |
