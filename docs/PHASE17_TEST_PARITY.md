...
**14 rows (`not-implemented` + `missing-test`, 0%) are real, actionable
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 115 | 170 | 6 | 128 | 0 | 4 | 26 |
...
| **Total** | | **3,179** | **950** | **658** | **210** | **765** | **10** | **4** | **582** |
