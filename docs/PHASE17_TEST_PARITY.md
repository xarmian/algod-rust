...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,074 | 34% |
| `matched-1:many` | 884 | 28% |
| `out-of-scope` | 654 | 21% |
| `partial` | 329 | 10% |
...
implements but never tests. `partial` (329, 10%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 102 | 79 | 12 | 42 | 0 | 0 | 28 |
...
| **Total** | | **3,181** | **1074** | **884** | **240** | **329** | **0** | **0** | **654** |
