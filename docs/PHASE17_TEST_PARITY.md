...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,163 | 37% |
| `matched-1:many` | 922 | 29% |
| `out-of-scope` | 700 | 22% |
| `matched-many:1` | 283 | 9% |
| `partial` | 111 | 3% |
| `missing-test` | 2 | 0% |
| `not-implemented` | 0 | 0% |
...
implements but never tests. `partial` (111, 3%) is coverage that exists
...
| Data structures (`data/basics`, `data/bookkeeping`, ...) | [parity_data_misc.md](phase17/parity_data_misc.md) | 274 | 133 | 39 | 46 | 28 | 0 | 0 | 28 |
...
| **Total** | | **3,181** | **1163** | **922** | **283** | **111** | **0** | **2** | **700** |
