...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,040 | 33% |
| `matched-1:many` | 793 | 25% |
| `out-of-scope` | 631 | 20% |
| `partial` | 480 | 15% |
| `matched-many:1` | 237 | 7% |
| `not-implemented` | 0 | 0% |
| `missing-test` | 0 | 0% |
...
implements but never tests. `partial` (480, 15%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 77 | 149 | 60 | 6 | 0 | 0 | 211 |
...
| **Total** | | **3,181** | **1040** | **793** | **237** | **480** | **0** | **0** | **631** |
