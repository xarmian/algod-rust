...
implements but never tests. `partial` (322, 10%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 105 | 79 | 12 | 35 | 0 | 0 | 32 |
...
| **Total** | | **3,181** | **1077** | **884** | **240** | **322** | **0** | **0** | **658** |
