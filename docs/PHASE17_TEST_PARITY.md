...
implements but never tests. `partial` (228, 7%) is coverage that exists
...
| e2e integration (`test/e2e-go`) | [parity_e2e.md](phase17/parity_e2e.md) | 195 | 78 | 45 | 3 | 4 | 0 | 0 | 65 |
...
| **Total** | | **3,181** | **1105** | **917** | **243** | **228** | **0** | **2** | **686** |
