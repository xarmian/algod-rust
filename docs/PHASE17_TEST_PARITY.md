...
| `out-of-scope` | 425 | 13% |
| `not-implemented` | 267 | 8% |
| `missing-test` | 230 | 7% |
| `matched-many:1` | 208 | 7% |

**497 rows (`not-implemented` + `missing-test`, 16%) are real, actionable
...
| Ledger simulation (`ledger/simulation`) | [parity_ledger_sim.md](phase17/parity_ledger_sim.md) | 68 | 30 | 21 | 0 | 6 | 8 | 2 | 1 |
...
| Tools/CLI (`tools/*`, `cmd/*`, ...) | [parity_tools_cmd.md](phase17/parity_tools_cmd.md) | 173 | 20 | 25 | 7 | 21 | 15 | 1 | 84 |
...
| **Total** | | **3,179** | **744** | **573** | **208** | **732** | **267** | **230** | **425** |
