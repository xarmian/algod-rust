...
| `partial` | 750 | 24% |
| `matched-1:1` | 675 | 21% |
| `matched-1:many` | 542 | 17% |
| `out-of-scope` | 381 | 12% |
| `not-implemented` | 333 | 10% |
| `missing-test` | 293 | 9% |
| `matched-many:1` | 205 | 6% |

**626 rows (`not-implemented` + `missing-test`, 20%) are real, actionable
...
| Agreement protocol (`agreement`) | [parity_agreement.md](phase17/parity_agreement.md) | 326 | 127 | 30 | 77 | 47 | 6 | 36 | 3 |
| e2e integration (`test/e2e-go`) | [parity_e2e.md](phase17/parity_e2e.md) | 195 | 30 | 18 | 0 | 64 | 0 | 57 | 26 |
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 83 | 51 | 11 | 72 | 23 | 20 | 3 |
...
| **Total** | | **3,179** | **675** | **542** | **205** | **750** | **333** | **293** | **381** |
