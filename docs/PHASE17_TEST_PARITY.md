...
implements but never tests. `partial` (330, 10%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 102 | 78 | 12 | 43 | 0 | 0 | 28 |
...
| **Total** | | **3,181** | **1074** | **883** | **240** | **330** | **0** | **0** | **654** |
