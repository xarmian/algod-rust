...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,064 | 33% |
| `matched-1:many` | 837 | 26% |
| `out-of-scope` | 639 | 20% |
| `partial` | 402 | 13% |
...
implements but never tests. `partial` (402, 13%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 141 | 224 | 6 | 44 | 0 | 0 | 34 |
...
| **Total** | | **3,181** | **1064** | **837** | **239** | **402** | **0** | **0** | **639** |
