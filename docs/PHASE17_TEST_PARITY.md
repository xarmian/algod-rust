...
implements but never tests. `partial` (299, 9%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 109 | 86 | 12 | 12 | 0 | 0 | 44 |
...
| **Total** | | **3,181** | **1081** | **891** | **240** | **299** | **0** | **0** | **670** |
