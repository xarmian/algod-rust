...
implements but never tests. `partial` (175, 6%) is coverage that exists
...
| Transactions core (`data/transactions`) | [parity_txn_core.md](phase17/parity_txn_core.md) | 175 | 75 | 46 | 30 | 5 | 0 | 0 | 19 |
...
| **Total** | | **3,181** | **1119** | **918** | **273** | **175** | **0** | **2** | **694** |
