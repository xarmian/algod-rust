...
implements but never tests. `partial` (547, 17%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 57 | 137 | 50 | 73 | 0 | 0 | 186 |
...
| **Total** | | **3,181** | **1020** | **781** | **227** | **547** | **0** | **0** | **606** |
