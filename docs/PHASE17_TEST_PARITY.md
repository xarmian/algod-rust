...
implements but never tests. `partial` (229, 7%) is coverage that exists
...
| e2e integration (`test/e2e-go`) | [parity_e2e.md](phase17/parity_e2e.md) | 195 | 78 | 44 | 3 | 5 | 0 | 0 | 65 |
...
| **Total** | | **3,181** | **1105** | **916** | **243** | **229** | **0** | **2** | **686** |
