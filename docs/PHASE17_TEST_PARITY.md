...
implements but never tests. `partial` (338, 11%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 101 | 73 | 12 | 51 | 0 | 0 | 26 |
...
| **Total** | | **3,181** | **1073** | **878** | **240** | **338** | **0** | **0** | **652** |
