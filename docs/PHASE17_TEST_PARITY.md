...
implements but never tests. `partial` (462, 15%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 120 | 189 | 6 | 104 | 0 | 0 | 30 |
...
| **Total** | | **3,181** | **1043** | **802** | **239** | **462** | **0** | **0** | **635** |
