...
implements but never tests. `partial` (573, 18%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 54 | 130 | 48 | 99 | 0 | 0 | 172 |
...
| **Total** | | **3,181** | **1017** | **774** | **225** | **573** | **0** | **0** | **592** |
