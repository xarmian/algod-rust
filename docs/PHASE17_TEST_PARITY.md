...
| `matched-1:many` | 483 | 15% |
| `out-of-scope` | 372 | 12% |
| `missing-test` | 359 | 11% |
| `matched-many:1` | 201 | 6% |

**879 rows (`not-implemented` + `missing-test`, 28%) are real, actionable
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 42 | 94 | 40 | 132 | 40 | 24 | 131 |
...
| **Total** | | **3,177** | **522** | **483** | **201** | **720** | **520** | **359** | **372** |
