...
**618 rows (`not-implemented` + `missing-test`, 19%) are real, actionable
...
| Agreement protocol (`agreement`) | [parity_agreement.md](phase17/parity_agreement.md) | 326 | 130 | 30 | 77 | 47 | 6 | 33 | 3 |
...
| **Total** | | **3,179** | **679** | **545** | **205** | **751** | **330** | **288** | **381** |
