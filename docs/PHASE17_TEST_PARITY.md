...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,024 | 32% |
| `matched-1:many` | 783 | 25% |
| `out-of-scope` | 606 | 19% |
| `partial` | 541 | 17% |
...
implements but never tests. `partial` (541, 17%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 61 | 139 | 50 | 67 | 0 | 0 | 186 |
...
| **Total** | | **3,181** | **1024** | **783** | **227** | **541** | **0** | **0** | **606** |
