...
implements but never tests. `partial` (4, 0%) is coverage that exists
...
| Agreement protocol (`agreement`) | [parity_agreement.md](phase17/parity_agreement.md) | 326 | 160 | 64 | 88 | 4 | 0 | 0 | 10 |
...
| **Total** | | **3,181** | **1207** | **948** | **285** | **4** | **0** | **0** | **737** |
