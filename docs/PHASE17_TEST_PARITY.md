...
implements but never tests. `partial` (546, 17%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 57 | 138 | 50 | 72 | 0 | 0 | 186 |
...
| **Total** | | **3,181** | **1020** | **782** | **227** | **546** | **0** | **0** | **606** |
