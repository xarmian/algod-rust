...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,066 | 34% |
| `matched-1:many` | 842 | 26% |
| `out-of-scope` | 641 | 20% |
| `partial` | 393 | 12% |
...
implements but never tests. `partial` (393, 12%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 143 | 229 | 6 | 35 | 0 | 0 | 36 |
...
| **Total** | | **3,181** | **1066** | **842** | **239** | **393** | **0** | **0** | **641** |
