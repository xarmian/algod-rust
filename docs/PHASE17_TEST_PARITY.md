...
| `missing-test` | 181 | 6% |
| `not-implemented` | 150 | 5% |

**331 rows (`not-implemented` + `missing-test`, 10%) are real, actionable
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 45 | 102 | 44 | 132 | 1 | 7 | 172 |
...
| **Total** | | **3,179** | **827** | **615** | **209** | **738** | **150** | **181** | **459** |
