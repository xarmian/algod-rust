...
**905 rows (`not-implemented` + `missing-test`, 28%) are real, actionable
...
| Agreement protocol (`agreement`) | [parity_agreement.md](phase17/parity_agreement.md) | 326 | 106 | 28 | 77 | 47 | 6 | 59 | 3 |
...
| **Total** | | **3,177** | **516** | **476** | **200** | **718** | **520** | **385** | **362** |
