...
implements but never tests. `partial` (599, 19%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 118 | 181 | 6 | 118 | 0 | 0 | 26 |
...
| **Total** | | **3,179** | **1013** | **753** | **221** | **599** | **0** | **0** | **593** |
