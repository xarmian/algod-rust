...
implements but never tests. `partial` (673, 21%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 117 | 177 | 6 | 123 | 0 | 0 | 26 |
...
| **Total** | | **3,179** | **981** | **723** | **214** | **673** | **0** | **0** | **588** |
