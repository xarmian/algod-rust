...
| `not-implemented` | 423 | 13% |
| `out-of-scope` | 381 | 12% |
| `missing-test` | 300 | 9% |
| `matched-many:1` | 205 | 6% |

**723 rows (`not-implemented` + `missing-test`, 23%) are real, actionable
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 59 | 47 | 11 | 60 | 63 | 20 | 3 |
...
| **Total** | | **3,177** | **629** | **515** | **205** | **724** | **423** | **300** | **381** |
