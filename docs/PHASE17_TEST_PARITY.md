...
implements but never tests. `partial` (557, 18%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 56 | 130 | 50 | 83 | 0 | 0 | 184 |
...
| **Total** | | **3,181** | **1019** | **774** | **227** | **557** | **0** | **0** | **604** |
