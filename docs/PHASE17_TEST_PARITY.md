...
| `not-implemented` | 417 | 13% |
| `out-of-scope` | 380 | 12% |
| `missing-test` | 299 | 9% |
| `matched-many:1` | 205 | 6% |

**716 rows (`not-implemented` + `missing-test`, 23%) are real, actionable
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 57 | 47 | 11 | 70 | 57 | 19 | 2 |
...
| **Total** | | **3,177** | **627** | **515** | **205** | **734** | **417** | **299** | **380** |
