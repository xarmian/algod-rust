...
| `matched-1:1` | 792 | 25% |
| `partial` | 733 | 23% |
| `matched-1:many` | 594 | 19% |
| `out-of-scope` | 425 | 13% |
| `not-implemented` | 226 | 7% |
| `matched-many:1` | 209 | 7% |
| `missing-test` | 200 | 6% |

**426 rows (`not-implemented` + `missing-test`, 13%) are real, actionable
...
| Ledger simulation (`ledger/simulation`) | [parity_ledger_sim.md](phase17/parity_ledger_sim.md) | 68 | 32 | 23 | 0 | 6 | 4 | 2 | 1 |
...
| **Total** | | **3,179** | **792** | **594** | **209** | **733** | **226** | **200** | **425** |
