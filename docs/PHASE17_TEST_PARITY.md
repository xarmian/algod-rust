...
| `missing-test` | 181 | 6% |
| `not-implemented` | 136 | 4% |

**317 rows (`not-implemented` + `missing-test`, 10%) are real, actionable
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 83 | 54 | 11 | 75 | 17 | 20 | 3 |
...
| **Total** | | **3,179** | **839** | **616** | **209** | **739** | **136** | **181** | **459** |
