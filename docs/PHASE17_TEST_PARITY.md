...
| `matched-1:1` | 747 | 23% |
| `partial` | 732 | 23% |
| `matched-1:many` | 571 | 18% |
| `out-of-scope` | 425 | 13% |
| `not-implemented` | 266 | 8% |
| `missing-test` | 230 | 7% |
| `matched-many:1` | 208 | 7% |

**496 rows (`not-implemented` + `missing-test`, 16%) are real, actionable
...
| Tools/CLI (`tools/*`, `cmd/*`, ...) | [parity_tools_cmd.md](phase17/parity_tools_cmd.md) | 173 | 23 | 23 | 7 | 21 | 14 | 1 | 84 |
...
| **Total** | | **3,179** | **747** | **571** | **208** | **732** | **266** | **230** | **425** |
