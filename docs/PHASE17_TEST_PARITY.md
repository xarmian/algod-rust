...
implements but never tests. `partial` (256, 8%) is coverage that exists
...
| e2e integration (`test/e2e-go`) | [parity_e2e.md](phase17/parity_e2e.md) | 195 | 72 | 40 | 3 | 32 | 0 | 0 | 48 |
...
| **Total** | | **3,181** | **1099** | **912** | **243** | **256** | **0** | **2** | **669** |
