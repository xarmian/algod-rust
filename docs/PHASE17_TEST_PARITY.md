...
**7 rows (`not-implemented` + `missing-test`, 0%) are real, actionable
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 97 | 60 | 11 | 76 | 4 | 0 | 15 |
...
| **Total** | | **3,179** | **952** | **663** | **210** | **765** | **6** | **1** | **582** |
