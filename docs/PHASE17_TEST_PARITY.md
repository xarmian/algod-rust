...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,042 | 33% |
| `matched-1:many` | 801 | 25% |
| `out-of-scope` | 635 | 20% |
| `partial` | 464 | 15% |
...
implements but never tests. `partial` (464, 15%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 119 | 188 | 6 | 106 | 0 | 0 | 30 |
...
| **Total** | | **3,181** | **1042** | **801** | **239** | **464** | **0** | **0** | **635** |
