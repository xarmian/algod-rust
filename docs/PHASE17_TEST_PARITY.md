...
**954 rows (`not-implemented` + `missing-test`, 30%) are real, actionable
gaps** — either a behavior algod-rust doesn't implement yet, or one it
implements but never tests. `partial` (715, 23%) is coverage that exists
...
| Agreement protocol (`agreement`) | [parity_agreement.md](phase17/parity_agreement.md) | 326 | 100 | 28 | 77 | 47 | 6 | 65 | 3 |
...
| **Total** | | **3,177** | **506** | **469** | **200** | **715** | **551** | **403** | **333** |
