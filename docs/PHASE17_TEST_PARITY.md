...
implements but never tests. `partial` (273, 9%) is coverage that exists
...
| e2e integration (`test/e2e-go`) | [parity_e2e.md](phase17/parity_e2e.md) | 195 | 62 | 33 | 3 | 49 | 0 | 0 | 48 |
...
| **Total** | | **3,181** | **1089** | **905** | **243** | **273** | **0** | **2** | **669** |
