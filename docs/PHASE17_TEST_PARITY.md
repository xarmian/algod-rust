...
implements but never tests. `partial` (360, 11%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 147 | 253 | 6 | 2 | 0 | 0 | 41 |
...
| **Total** | | **3,181** | **1070** | **866** | **239** | **360** | **0** | **0** | **646** |
