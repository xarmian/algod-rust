...
implements but never tests. `partial` (291, 9%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 113 | 90 | 12 | 4 | 0 | 0 | 44 |
...
| **Total** | | **3,181** | **1085** | **895** | **240** | **291** | **0** | **0** | **670** |
