...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,119 | 35% |
| `matched-1:many` | 918 | 29% |
| `out-of-scope` | 694 | 22% |
| `matched-many:1` | 275 | 9% |
| `partial` | 173 | 5% |
| `missing-test` | 2 | 0% |
| `not-implemented` | 0 | 0% |
...
implements but never tests. `partial` (173, 5%) is coverage that exists
...
| Transactions core (`data/transactions`) | [parity_txn_core.md](phase17/parity_txn_core.md) | 175 | 75 | 46 | 32 | 3 | 0 | 0 | 19 |
...
| **Total** | | **3,181** | **1119** | **918** | **275** | **173** | **0** | **2** | **694** |
