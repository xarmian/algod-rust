...
## Aggregate totals (3,182 go-algorand tests)

| status | count | share |
|---|---|---|
| `matched-1:1` | 1,044 | 33% |
| `matched-1:many` | 810 | 25% |
| `out-of-scope` | 638 | 20% |
| `partial` | 451 | 14% |
...
implements but never tests. `partial` (451, 14%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 450 | 121 | 197 | 6 | 93 | 0 | 0 | 33 |
...
| **Total** | | **3,182** | **1044** | **810** | **239** | **451** | **0** | **0** | **638** |
