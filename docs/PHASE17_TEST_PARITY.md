...
implements but never tests. `partial` (300, 9%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 109 | 85 | 12 | 13 | 0 | 0 | 44 |
...
| **Total** | | **3,181** | **1081** | **890** | **240** | **300** | **0** | **0** | **670** |
