...
| `missing-test` | 181 | 6% |
| `not-implemented` | 114 | 4% |

**295 rows (`not-implemented` + `missing-test`, 9%) are real, actionable
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 87 | 159 | 6 | 123 | 5 | 45 | 24 |
