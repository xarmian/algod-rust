...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,085 | 34% |
| `matched-1:many` | 896 | 28% |
| `out-of-scope` | 670 | 21% |
| `partial` | 290 | 9% |
...
implements but never tests. `partial` (290, 9%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 113 | 91 | 12 | 3 | 0 | 0 | 44 |
...
| **Total** | | **3,181** | **1085** | **896** | **240** | **290** | **0** | **0** | **670** |
