...
implements but never tests. `partial` (254, 8%) is coverage that exists
...
| e2e integration (`test/e2e-go`) | [parity_e2e.md](phase17/parity_e2e.md) | 195 | 72 | 42 | 3 | 30 | 0 | 0 | 48 |
...
| **Total** | | **3,181** | **1099** | **914** | **243** | **254** | **0** | **2** | **669** |
