...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,089 | 34% |
| `matched-1:many` | 902 | 28% |
| `out-of-scope` | 668 | 21% |
| `partial` | 280 | 9% |
...
implements but never tests. `partial` (280, 9%) is coverage that exists
...
| e2e integration (`test/e2e-go`) | [parity_e2e.md](phase17/parity_e2e.md) | 195 | 62 | 30 | 0 | 56 | 0 | 0 | 47 |
...
| **Total** | | **3,181** | **1089** | **902** | **240** | **280** | **0** | **2** | **668** |
