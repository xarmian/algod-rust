...
implements but never tests. `partial` (323, 10%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 104 | 79 | 12 | 36 | 0 | 0 | 32 |
...
| **Total** | | **3,181** | **1076** | **884** | **240** | **323** | **0** | **0** | **658** |
