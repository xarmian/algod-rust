...
implements but never tests. `partial` (288, 9%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 113 | 93 | 12 | 1 | 0 | 0 | 44 |
...
| **Total** | | **3,181** | **1085** | **898** | **240** | **288** | **0** | **0** | **670** |
