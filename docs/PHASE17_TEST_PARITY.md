...
implements but never tests. `partial` (435, 14%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 128 | 205 | 6 | 77 | 0 | 0 | 33 |
...
| **Total** | | **3,181** | **1051** | **818** | **239** | **435** | **0** | **0** | **638** |
