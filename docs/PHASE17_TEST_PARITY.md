...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,012 | 32% |
| `matched-1:many` | 759 | 24% |
| `partial` | 597 | 19% |
| `out-of-scope` | 592 | 19% |
...
implements but never tests. `partial` (597, 19%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 118 | 182 | 6 | 117 | 0 | 0 | 26 |
| Transactions core (`data/transactions`) | [parity_txn_core.md](phase17/parity_txn_core.md) | 175 | 63 | 45 | 0 | 54 | 0 | 0 | 13 |
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 49 | 116 | 44 | 122 | 0 | 0 | 172 |
...
| Data structures (`data/basics`, `data/bookkeeping`, ...) | [parity_data_misc.md](phase17/parity_data_misc.md) | 274 | 127 | 36 | 45 | 41 | 0 | 0 | 25 |
...
| **Total** | | **3,181** | **1012** | **759** | **221** | **597** | **0** | **0** | **592** |
