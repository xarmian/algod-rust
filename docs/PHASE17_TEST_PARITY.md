...
implements but never tests. `partial` (667, 21%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 98 | 61 | 11 | 73 | 0 | 0 | 20 |
...
| **Total** | | **3,179** | **982** | **726** | **214** | **667** | **0** | **0** | **590** |
