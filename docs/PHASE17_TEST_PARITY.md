...
| `matched-1:1` | 953 | 30% |
| `partial` | 765 | 24% |
| `matched-1:many` | 663 | 21% |
| `out-of-scope` | 587 | 18% |
| `matched-many:1` | 210 | 7% |
| `missing-test` | 1 | 0% |
| `not-implemented` | 0 | 0% |

**1 rows (`not-implemented` + `missing-test`, 0%) are real, actionable
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 116 | 172 | 6 | 128 | 0 | 1 | 26 |
...
| **Total** | | **3,179** | **953** | **663** | **210** | **765** | **0** | **1** | **587** |
