...
implements but never tests. `partial` (588, 18%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 49 | 124 | 44 | 114 | 0 | 0 | 172 |
...
| **Total** | | **3,181** | **1012** | **768** | **221** | **588** | **0** | **0** | **592** |
