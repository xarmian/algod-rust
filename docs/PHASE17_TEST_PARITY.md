...
| `partial` | 735 | 23% |
| `matched-1:1` | 730 | 23% |
| `matched-1:many` | 560 | 18% |
| `out-of-scope` | 425 | 13% |
| `not-implemented` | 281 | 9% |
| `missing-test` | 240 | 8% |
| `matched-many:1` | 208 | 7% |

**521 rows (`not-implemented` + `missing-test`, 16%) are real, actionable
...
| Ledger simulation (`ledger/simulation`) | [parity_ledger_sim.md](phase17/parity_ledger_sim.md) | 68 | 30 | 17 | 0 | 9 | 9 | 2 | 1 |
...
| **Total** | | **3,179** | **730** | **560** | **208** | **735** | **281** | **240** | **425** |
