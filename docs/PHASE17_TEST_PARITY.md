...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,084 | 34% |
| `matched-1:many` | 895 | 28% |
| `out-of-scope` | 670 | 21% |
| `partial` | 292 | 9% |
...
implements but never tests. `partial` (292, 9%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 112 | 90 | 12 | 5 | 0 | 0 | 44 |
...
| **Total** | | **3,181** | **1084** | **895** | **240** | **292** | **0** | **0** | **670** |
