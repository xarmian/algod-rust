...
|---|---|---|
| `partial` | 713 | 22% |
| `not-implemented` | 552 | 17% |
| `matched-1:1` | 486 | 15% |
| `matched-1:many` | 465 | 15% |
| `missing-test` | 428 | 13% |
| `out-of-scope` | 333 | 10% |
| `matched-many:1` | 200 | 6% |

**980 rows (`not-implemented` + `missing-test`, 31%) are real, actionable
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 53 | 133 | 6 | 121 | 29 | 84 | 23 |
...
| **Total** | | **3,177** | **486** | **465** | **200** | **713** | **552** | **428** | **333** |
