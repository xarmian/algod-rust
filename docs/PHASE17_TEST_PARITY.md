...
implements but never tests. `partial` (470, 15%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 118 | 187 | 6 | 112 | 0 | 0 | 26 |
...
| **Total** | | **3,181** | **1041** | **800** | **239** | **470** | **0** | **0** | **631** |
