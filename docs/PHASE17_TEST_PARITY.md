...
**376 rows (`not-implemented` + `missing-test`, 12%) are real, actionable
...
| Agreement protocol (`agreement`) | [parity_agreement.md](phase17/parity_agreement.md) | 326 | 143 | 37 | 77 | 49 | 0 | 17 | 3 |
...
| **Total** | | **3,179** | **819** | **611** | **209** | **740** | **194** | **182** | **424** |
