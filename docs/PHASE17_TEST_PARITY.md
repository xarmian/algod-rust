...
| `matched-1:1` | 846 | 27% |
| `partial` | 739 | 23% |
| `matched-1:many` | 622 | 20% |
| `out-of-scope` | 469 | 15% |
| `matched-many:1` | 209 | 7% |
| `missing-test` | 181 | 6% |
| `not-implemented` | 113 | 4% |

**294 rows (`not-implemented` + `missing-test`, 9%) are real, actionable
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 87 | 160 | 6 | 123 | 4 | 45 | 24 |
...
| **Total** | | **3,179** | **846** | **622** | **209** | **739** | **113** | **181** | **469** |
