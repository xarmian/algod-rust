...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,082 | 34% |
| `matched-1:many` | 894 | 28% |
| `out-of-scope` | 670 | 21% |
| `partial` | 295 | 9% |
...
implements but never tests. `partial` (295, 9%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 110 | 89 | 12 | 8 | 0 | 0 | 44 |
...
| **Total** | | **3,181** | **1082** | **894** | **240** | **295** | **0** | **0** | **670** |
