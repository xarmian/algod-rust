...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,041 | 33% |
| `matched-1:many` | 794 | 25% |
| `out-of-scope` | 631 | 20% |
| `partial` | 476 | 15% |
...
implements but never tests. `partial` (476, 15%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 78 | 150 | 62 | 2 | 0 | 0 | 211 |
...
| **Total** | | **3,181** | **1041** | **794** | **239** | **476** | **0** | **0** | **631** |
