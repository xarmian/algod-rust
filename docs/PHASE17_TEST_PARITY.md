...
| `not-implemented` | 440 | 14% |
| `out-of-scope` | 380 | 12% |
| `missing-test` | 299 | 9% |
| `matched-many:1` | 205 | 6% |

**739 rows (`not-implemented` + `missing-test`, 23%) are real, actionable
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 80 | 147 | 6 | 122 | 22 | 48 | 24 |
...
| **Total** | | **3,177** | **614** | **515** | **205** | **724** | **440** | **299** | **380** |
