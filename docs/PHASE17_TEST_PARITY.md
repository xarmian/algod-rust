...
implements but never tests. `partial` (403, 13%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 141 | 223 | 6 | 45 | 0 | 0 | 34 |
...
| **Total** | | **3,181** | **1064** | **836** | **239** | **403** | **0** | **0** | **639** |
