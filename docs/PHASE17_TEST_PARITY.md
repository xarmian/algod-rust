...
| `missing-test` | 181 | 6% |
| `not-implemented` | 111 | 3% |

**292 rows (`not-implemented` + `missing-test`, 9%) are real, actionable
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 88 | 160 | 6 | 124 | 2 | 45 | 24 |
...
| **Total** | | **3,179** | **846** | **621** | **209** | **739** | **114** | **181** | **469** |
