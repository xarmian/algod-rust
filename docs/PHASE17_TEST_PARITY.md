...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,096 | 34% |
| `matched-1:many` | 912 | 29% |
| `out-of-scope` | 669 | 21% |
| `partial` | 259 | 8% |
...
implements but never tests. `partial` (259, 8%) is coverage that exists
...
| e2e integration (`test/e2e-go`) | [parity_e2e.md](phase17/parity_e2e.md) | 195 | 69 | 40 | 3 | 35 | 0 | 0 | 48 |
...
| **Total** | | **3,181** | **1096** | **912** | **243** | **259** | **0** | **2** | **669** |
