...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,062 | 33% |
| `matched-1:many` | 827 | 26% |
| `out-of-scope` | 638 | 20% |
| `partial` | 415 | 13% |
...
implements but never tests. `partial` (415, 13%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 139 | 214 | 6 | 57 | 0 | 0 | 33 |
...
| **Total** | | **3,181** | **1062** | **827** | **239** | **415** | **0** | **0** | **638** |
