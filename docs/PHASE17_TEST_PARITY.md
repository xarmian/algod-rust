...
| `matched-1:1` | 847 | 27% |
| `partial` | 740 | 23% |
| `matched-1:many` | 623 | 20% |
| `out-of-scope` | 469 | 15% |
| `matched-many:1` | 209 | 7% |
| `missing-test` | 181 | 6% |
| `not-implemented` | 110 | 3% |

**291 rows (`not-implemented` + `missing-test`, 9%) are real, actionable
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 88 | 161 | 6 | 124 | 1 | 45 | 24 |
...
| **Total** | | **3,179** | **847** | **623** | **209** | **740** | **110** | **181** | **469** |
