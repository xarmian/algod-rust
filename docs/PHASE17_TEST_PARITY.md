...
implements but never tests. `partial` (394, 12%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 142 | 229 | 6 | 36 | 0 | 0 | 36 |
...
| **Total** | | **3,181** | **1065** | **842** | **239** | **394** | **0** | **0** | **641** |
