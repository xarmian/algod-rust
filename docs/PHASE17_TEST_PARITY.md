...
| `matched-1:1` | 762 | 24% |
| `partial` | 736 | 23% |
| `matched-1:many` | 582 | 18% |
| `out-of-scope` | 425 | 13% |
| `not-implemented` | 236 | 7% |
| `missing-test` | 229 | 7% |
| `matched-many:1` | 209 | 7% |

**465 rows (`not-implemented` + `missing-test`, 15%) are real, actionable
...
| Agreement protocol (`agreement`) | [parity_agreement.md](phase17/parity_agreement.md) | 326 | 134 | 33 | 77 | 49 | 0 | 30 | 3 |
...
| Daemon/node/rpcs (`daemon/algod`, `node`, `rpcs`) | [parity_daemon_node.md](phase17/parity_daemon_node.md) | 144 | 45 | 50 | 1 | 12 | 12 | 13 | 11 |
...
| **Total** | | **3,179** | **762** | **582** | **209** | **736** | **236** | **229** | **425** |
