...
implements but never tests. `partial` (666, 21%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 98 | 62 | 11 | 72 | 0 | 0 | 20 |
...
| **Total** | | **3,179** | **982** | **727** | **214** | **666** | **0** | **0** | **590** |
