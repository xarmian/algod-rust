...
implements but never tests. `partial` (685, 22%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 49 | 106 | 44 | 131 | 0 | 0 | 173 |
...
| Crypto (`crypto`, `crypto/stateproof`, ...) | [parity_crypto.md](phase17/parity_crypto.md) | 276 | 121 | 40 | 17 | 56 | 0 | 0 | 42 |
...
| **Total** | | **3,179** | **980** | **713** | **213** | **685** | **0** | **0** | **588** |
