...
implements but never tests. `partial` (346, 11%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 99 | 72 | 11 | 59 | 0 | 0 | 22 |
...
| **Total** | | **3,181** | **1071** | **877** | **239** | **346** | **0** | **0** | **648** |
