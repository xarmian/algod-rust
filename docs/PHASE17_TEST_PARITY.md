...
implements but never tests. `partial` (558, 18%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 56 | 130 | 49 | 84 | 0 | 0 | 184 |
...
| **Total** | | **3,181** | **1019** | **774** | **226** | **558** | **0** | **0** | **604** |
