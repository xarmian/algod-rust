...
**624 rows (`not-implemented` + `missing-test`, 20%) are real, actionable
...
| Agreement protocol (`agreement`) | [parity_agreement.md](phase17/parity_agreement.md) | 326 | 128 | 30 | 77 | 47 | 6 | 35 | 3 |
...
| **Total** | | **3,179** | **676** | **544** | **205** | **749** | **332** | **292** | **381** |
