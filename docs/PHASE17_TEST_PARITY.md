...
| `partial` | 750 | 24% |
| `matched-1:1` | 675 | 21% |
| `matched-1:many` | 541 | 17% |
| `out-of-scope` | 381 | 12% |
| `not-implemented` | 334 | 11% |
| `missing-test` | 293 | 9% |
| `matched-many:1` | 205 | 6% |

**627 rows (`not-implemented` + `missing-test`, 20%) are real, actionable
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 84 | 151 | 6 | 121 | 16 | 47 | 24 |
...
| **Total** | | **3,179** | **675** | **541** | **205** | **750** | **334** | **293** | **381** |
