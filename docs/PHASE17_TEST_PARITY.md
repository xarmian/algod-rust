...
implements but never tests. `partial` (582, 18%) is coverage that exists
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 49 | 130 | 44 | 108 | 0 | 0 | 172 |
...
| **Total** | | **3,181** | **1012** | **774** | **221** | **582** | **0** | **0** | **592** |
