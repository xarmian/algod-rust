...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,111 | 35% |
| `matched-1:many` | 917 | 29% |
| `out-of-scope` | 688 | 22% |
...
implements but never tests. `partial` (220, 7%) is coverage that exists
...
| Transactions core (`data/transactions`) | [parity_txn_core.md](phase17/parity_txn_core.md) | 175 | 67 | 45 | 0 | 50 | 0 | 0 | 13 |
...
| **Total** | | **3,181** | **1111** | **917** | **243** | **220** | **0** | **2** | **688** |
