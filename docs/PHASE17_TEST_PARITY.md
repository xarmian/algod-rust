...
implements but never tests. `partial` (600, 19%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 118 | 180 | 6 | 119 | 0 | 0 | 26 |
...
| **Total** | | **3,179** | **1013** | **752** | **221** | **600** | **0** | **0** | **593** |
