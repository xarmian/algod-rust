...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,067 | 34% |
| `matched-1:many` | 846 | 27% |
| `out-of-scope` | 641 | 20% |
| `partial` | 388 | 12% |
...
implements but never tests. `partial` (388, 12%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 144 | 233 | 6 | 30 | 0 | 0 | 36 |
...
| **Total** | | **3,181** | **1067** | **846** | **239** | **388** | **0** | **0** | **641** |
