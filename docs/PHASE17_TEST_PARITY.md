...
implements but never tests. `partial` (471, 15%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 118 | 186 | 6 | 113 | 0 | 0 | 26 |
...
| **Total** | | **3,181** | **1041** | **799** | **239** | **471** | **0** | **0** | **631** |
