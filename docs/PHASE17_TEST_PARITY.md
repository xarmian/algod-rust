...
| status | count | share |
|---|---|---|
| `matched-1:1` | 1,073 | 34% |
| `matched-1:many` | 879 | 28% |
| `out-of-scope` | 652 | 20% |
| `partial` | 337 | 11% |
...
implements but never tests. `partial` (337, 11%) is coverage that exists
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 101 | 74 | 12 | 50 | 0 | 0 | 26 |
...
| **Total** | | **3,181** | **1073** | **879** | **240** | **337** | **0** | **0** | **652** |
