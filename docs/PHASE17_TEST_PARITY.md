...
**6 rows (`not-implemented` + `missing-test`, 0%) are real, actionable
...
| Networking (`network`, `network/p2p`, ...) | [parity_network.md](phase17/parity_network.md) | 263 | 98 | 60 | 11 | 76 | 3 | 0 | 15 |
...
| **Total** | | **3,179** | **953** | **663** | **210** | **765** | **5** | **1** | **582** |
