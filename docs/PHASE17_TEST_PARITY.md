...
| `partial` | 751 | 24% |
| `matched-1:1` | 681 | 21% |
| `matched-1:many` | 546 | 17% |
| `out-of-scope` | 381 | 12% |
| `not-implemented` | 330 | 10% |
| `missing-test` | 285 | 9% |
| `matched-many:1` | 205 | 6% |

**615 rows (`not-implemented` + `missing-test`, 19%) are real, actionable
gaps** — either a behavior algod-rust doesn't implement yet, or one it
implements but never tests. `partial` (751, 24%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 84 | 152 | 6 | 121 | 15 | 47 | 24 |
...
| Agreement protocol (`agreement`) | [parity_agreement.md](phase17/parity_agreement.md) | 326 | 131 | 30 | 77 | 47 | 6 | 32 | 3 |
...
| Daemon/node/rpcs (`daemon/algod`, `node`, `rpcs`) | [parity_daemon_node.md](phase17/parity_daemon_node.md) | 144 | 39 | 46 | 0 | 11 | 17 | 21 | 10 |
| Data structures (`data/basics`, `data/bookkeeping`, ...) | [parity_data_misc.md](phase17/parity_data_misc.md) | 274 | 86 | 15 | 45 | 68 | 28 | 25 | 7 |
| Config/stateproof/protocol | [parity_config_proto_sp.md](phase17/parity_config_proto_sp.md) | 119 | 18 | 21 | 0 | 30 | 40 | 6 | 4 |
...
| **Total** | | **3,179** | **681** | **546** | **205** | **751** | **330** | **285** | **381** |
