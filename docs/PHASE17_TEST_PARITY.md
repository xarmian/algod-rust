...
implements but never tests. `partial` (427, 13%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 128 | 213 | 6 | 69 | 0 | 0 | 33 |
...
| **Total** | | **3,181** | **1051** | **826** | **239** | **427** | **0** | **0** | **638** |
