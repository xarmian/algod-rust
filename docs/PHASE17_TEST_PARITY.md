...
implements but never tests. `partial` (226, 7%) is coverage that exists
...
| e2e integration (`test/e2e-go`) | [parity_e2e.md](phase17/parity_e2e.md) | 195 | 80 | 45 | 3 | 2 | 0 | 0 | 65 |
...
| **Total** | | **3,181** | **1107** | **917** | **243** | **226** | **0** | **2** | **686** |
