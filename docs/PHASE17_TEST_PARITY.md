...
**875 rows (`not-implemented` + `missing-test`, 28%) are real, actionable
...
| Ledger core (`ledger`, `ledger/eval`, `ledger/apply`, `ledger/ledgercore`, `ledger/store`, `ledger/encoded`) | [parity_ledger_core.md](phase17/parity_ledger_core.md) | 503 | 41 | 94 | 43 | 132 | 40 | 20 | 133 |
...
| **Total** | | **3,177** | **521** | **483** | **204** | **720** | **520** | **355** | **374** |
