...
implements but never tests. `partial` (458, 14%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 121 | 192 | 6 | 100 | 0 | 0 | 30 |
...
| **Total** | | **3,181** | **1044** | **805** | **239** | **458** | **0** | **0** | **635** |
