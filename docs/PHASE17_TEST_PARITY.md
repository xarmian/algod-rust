...
implements but never tests. `partial` (416, 13%) is coverage that exists
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| AVM/TEAL opcodes (`data/transactions/logic`) | [parity_txn_logic.md](phase17/parity_txn_logic.md) | 449 | 138 | 214 | 6 | 58 | 0 | 0 | 33 |
...
| **Total** | | **3,181** | **1061** | **827** | **239** | **416** | **0** | **0** | **638** |
