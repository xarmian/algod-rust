...
implements but never tests. `partial` (276, 9%) is coverage that exists
...
| e2e integration (`test/e2e-go`) | [parity_e2e.md](phase17/parity_e2e.md) | 195 | 62 | 30 | 3 | 52 | 0 | 0 | 48 |
...
| **Total** | | **3,181** | **1089** | **902** | **243** | **276** | **0** | **2** | **669** |
