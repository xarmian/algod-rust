...
100% protocol conformance with go-algorand. The Go reference implementation (`../go-algorand`, pinned to `v4.5.1-stable`) is the source of truth for all protocol behavior, field values, algorithm implementations, domain separation strings, consensus parameters, and edge cases.
