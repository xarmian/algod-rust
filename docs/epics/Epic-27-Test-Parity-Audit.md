...
- [ ] #911 — agreement: investigate 5-node convergence stall in the new multi-node service-level test harness (found while working #825/#910) — root cause (harness artifact vs. genuine `Service`/`Player` liveness bug) undetermined, needs investigation
