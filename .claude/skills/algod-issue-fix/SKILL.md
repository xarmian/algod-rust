...
- Read `../go-algorand`'s real behavior for the relevant area before forming a hypothesis — this repo's bar is byte-level/behavioral parity with go-algorand v5.0.0-stable, not "something reasonable." Cite the specific go file/function once you have a root-cause theory.
