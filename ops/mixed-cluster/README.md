...
A 4-node docker-compose harness that runs 3 go-algorand v5.0.1-stable
...
- **go-node-1/2/3**: algorand/algod:5.0.1-stable relays with **30%** of
...
exported certificates with go-algorand v5.0.1-stable's own verifier.
...
6. Boot a one-shot `algorand/algod:5.0.1-stable` container against
