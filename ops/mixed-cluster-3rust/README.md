...
— that runs 3 go-algorand v4.7.4-stable nodes + 3 algod-rust nodes on a
...
v4.7.4-stable) stops packing votes into a certificate the instant
...
`tools/cert-authenticate` against a real go-algorand v4.7.4-stable
