...
— that runs 3 go-algorand v5.0.2-stable nodes + 3 algod-rust nodes on a
...
v5.0.2-stable) stops packing votes into a certificate the instant
...
`tools/cert-authenticate` against a real go-algorand v5.0.2-stable
