...
# Per-node round + liveness snapshot for the 1 go-algorand + 1 algod-rust
# 50/50-stake P2P harness (issue #1580). Mirrors
# ops/mixed-cluster-p2p/scripts/status.sh, adjusted for 2 nodes / this
# harness's container names and host ports (5101/5102).
...
declare -a ROWS=(
    "go-node-1|p2pinterop1v1-go-node-1|5101"
    "rust-node-2|p2pinterop1v1-rust-node-2|5102"
)
