module github.com/xarmian/algod-rust/tools/trie-element-capture
...
// (merkle-trie-root-capture, merkle-page-capture, lookback-vector-capture).
// See main.go's package comment for the required sibling-checkout setup.
